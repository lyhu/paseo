...
import { WebConfirmDialogProvider } from "@/components/ui/web-confirm-dialog-provider";
...
function AppContainer({
	...
	const openDesktopAgentList = usePanelStore(
		(state) => state.openDesktopAgentList,
	);
	const closeDesktopAgentList = usePanelStore(
		(state) => state.closeDesktopAgentList,
	);
	const closeDesktopFileExplorer = usePanelStore(
		(state) => state.closeDesktopFileExplorer,
	);
	...
	const isDesktopFileExplorerOpen = usePanelStore(
					...
					<ToastProvider>
						<PortalProvider>
							<BottomSheetModalProvider>
								<WebConfirmDialogProvider>{children}</WebConfirmDialogProvider>
							</BottomSheetModalProvider>
						</PortalProvider>
					</ToastProvider>
				</KeyboardShiftProvider>
